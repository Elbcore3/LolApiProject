var oso,osto;
if (instance_number(data_champs)==0) {
...
show_debug_message('https://global.api.pvp.net/api/lol/static-data/'+region+'/v1.2/champion?dataById=true&champData=info&api_key='+api_key);
